...
#define SONOS_STATE_ERROR 0
#define SONOS_STATE_ERROR_VALUE "ERROR"
#define SONOS_STATE_STOPPED 1
#define SONOS_STATE_STOPPED_VALUE "STOPPED"
#define SONOS_STATE_PLAYING 2
#define SONOS_STATE_PLAYING_VALUE "PLAYING"
#define SONOS_STATE_PAUSED 3
#define SONOS_STATE_PAUSED_VALUE "PAUSED_PLAYBACK"
#define SONOS_STATE_TRANSITIONING 4
#define SONOS_STATE_TRANSITIONING_VALUE "TRANSITIONING"
...
class SonosUPnP
{
  ...
  public:
    ...
    SonosUPnP(void (*ethernetErrCallback)(void));
    ...
    void playUri(IPAddress speakerIP, const char *address);
